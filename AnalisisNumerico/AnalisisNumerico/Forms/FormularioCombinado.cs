...
{
    public partial class FormularioCombinado : Form
    {
        public FormularioCombinado()
        {
            InitializeComponent();
        }
        ...
        private void BtnCalcularArea_Click(object sender, EventArgs e)
        {
            ...
            double areaResultante = integralSimpson.SimpsonCombinado(funcion, xi, xd, subintervalos);
