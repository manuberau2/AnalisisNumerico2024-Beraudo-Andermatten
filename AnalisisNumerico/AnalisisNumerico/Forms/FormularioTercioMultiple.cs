...
{
    public partial class FormularioTercioMultiple : Form
    {
        public FormularioTercioMultiple()
        {
            InitializeComponent();
        }
        ...
        private void BtnCalcularArea_Click(object sender, EventArgs e)
        {
            ...
            double areaResultante = integralSimpson.CalcularIntegralSimpson13Multiple(funcion, xi, xd, subintervalos);
