...
{
    public partial class FormularioTrapecioSimple : Form
    {
        public FormularioTrapecioSimple()
        {
            InitializeComponent();
        }
        ...
        private void BtnCalcularArea_Click(object sender, EventArgs e)
        {
            ...
            double areaResultante = integralTrapecios.CalcularTrapecioSimple(funcion, xi, xd);
