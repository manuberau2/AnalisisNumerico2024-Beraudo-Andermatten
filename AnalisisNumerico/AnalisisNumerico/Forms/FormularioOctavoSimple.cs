...
{
    public partial class FormularioOctavoSimple : Form
    {
        public FormularioOctavoSimple()
        {
            InitializeComponent();
        }
        ...
        private void BtnCalcularArea_Click(object sender, EventArgs e)
        {
            ...
            double areaResultante = integralSimpson.CalcularIntegralSimpson38(funcion, xi, xd);
